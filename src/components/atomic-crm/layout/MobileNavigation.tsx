      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            aria-label={translate("crm.create")}
          >
        ...
        <DropdownMenuContent>
          ...
          >
            {translate("crm.notes", { smart_count: 1 })}
          </DropdownMenuItem>
          <DropdownMenuItem
            className="h-12 px-4 text-base"
            onSelect={() => {
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="text-[0.6rem] font-medium">{translate("crm.settings")}</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent>
        ...
        >
          <LogOut />
          <Translate i18nKey="ra.auth.logout">Abmelden</Translate>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
